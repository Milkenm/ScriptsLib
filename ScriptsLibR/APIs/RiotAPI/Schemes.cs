...
namespace ScriptsLibR.APIs.RiotAPI
{
	...
	public class MatchDTO
	{
		...
		[JsonProperty("participantIdentities")] public List<ParticipantIdentityDTO> ParticipantIdentitiesList;
		...
		[JsonProperty("teams")] public List<TeamStatsDTO> TeamsList;

		/// <summary>Participant information.</summary>
		[JsonProperty("participants")] public List<ParticipantDTO> ParticipantsList;
	...
	public class ParticipantDTO
	{
		...
		[JsonProperty("highestAchievedSeasonTier")] public string HighestAchievedSeasonTier;

		/// <summary>First Summoner Spell id.</summary>
		[JsonProperty("spell1Id")] public int Spell1Id;
	...
	{
		[JsonProperty("id")] public string Id;
		[JsonProperty("localizedNames")] Dictionary<string, Dictionary<string, string>> LocalizedNames;
