...
namespace ScriptsLibV2.APIs.RiotGames
{
    ...
    public partial class RiotGamesAPI
    {
        ...
        public MatchDTO LoL_GetMatchById(LoLRegion region, long matchId)
        {
        ...
        public MatchlistDTO LoL_GetMatchHistory(LoLRegion region, string encryptedAccountId, int?[] champion, int?[] queue, long? endTime, long? beginTime, int? endIndex, int? beginIndex)
        {
        ...
        public MatchTimelineDTO LoL_GetMatchTimeline(LoLRegion region, long matchId)
        {
        ...
        public List<long> LoL_GetMatchIdByTournamentCode(LoLRegion region, string tournamentCode)
        {
        ...
        /// <param name="tournamentCode">The tournament code.</param>
        /// <param name="matchId">The match ID.</param>
        public MatchDTO LoL_GetMatchByIdAndTournamentCode(LoLRegion region, string tournamentCode, long matchId)
        {
