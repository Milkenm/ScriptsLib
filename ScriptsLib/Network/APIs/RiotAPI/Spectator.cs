...
namespace ScriptsLib.Network.APIs
{
	public static partial class RiotAPI
	{
		public static class Spectator // v4
		{
			...
			public static string GetCurrentGameInfo(string encryptedSummonerId) => GET(ServerString() + $"/lol/spectator/v4/active-games/by-summoner/{encryptedSummonerId}" + ApiString());

			/// <summary>Get list of featured games.</summary>
			public static string GetFeaturedGames() => GET(ServerString() + "/lol/spectator/v4/featured-games" + ApiString());
		}
	}
}
