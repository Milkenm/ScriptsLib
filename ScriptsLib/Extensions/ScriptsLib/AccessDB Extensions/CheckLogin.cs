...
{
	public static partial class AccessDBExtensions
	{
		...
		public static bool CheckLogin(this AccessDB db, string table, string usernameColumn, string passwordColumn, string username, string password)
		{
